...
def main():
    ...
    # Als end niet is opgegeven, gebruik dan de datum van vandaag
    if args.end:
        end = validate_date(args.end)
    else:
        end = datetime.now().strftime("%Y-%m-%d")
        print(f"[INFO] Geen einddatum opgegeven, gebruik vandaag: {end}")
    ...
    # Scarica Activities e Wellness (Wellness wordt nog gedownload maar we filteren dit in de workflow)
    fetch_csv("activities.csv", start, end, activities_path)
    fetch_csv("wellness.csv", start, end, wellness_path)
